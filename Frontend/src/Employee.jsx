...
function Employee() {
  const initialEmployees = [
    { id: 1, name: "Rahul Sharma", role: "Frontend Developer", department: "Engineering", email: "rahul.sharma@company.com", salary: 72000 },
    { id: 2, name: "Priya Menon", role: "Product Designer", department: "Design", email: "priya.menon@company.com", salary: 68000 },
    { id: 3, name: "Arjun Rao", role: "Project Manager", department: "Operations", email: "arjun.rao@company.com", salary: 79000 },
  ];
      ...
      <div style={{ display: "flex", flex: 1, gap: "18px", padding: "0" }}>
        ...
        <div style={{ flex: 1, padding: "20px 24px 24px 24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "14px", marginBottom: "20px", flexWrap: "wrap" }}>
            {cards.map((card) => <Card key={card.title} title={card.title} value={card.value} color={card.color} />)}
          </div>
