export const apiEndpoints = {
  ...
  programs: {
    ...
    byGroup: (groupId) => `/api/v1/programs/group/${encodeURIComponent(groupId)}`,
  },
  fee: {
    ...
    collect: "/api/v1/fees/payments",
    payments: "/api/v1/fees/payments",
    getHistory: (studentId) => `/api/v1/fees/students/${encodeURIComponent(studentId)}/payments`,
    studentPayments: (studentId) => `/api/v1/fees/students/${encodeURIComponent(studentId)}/payments`,
    getReceipt: (receiptId) => `/api/v1/fees/payments/${encodeURIComponent(receiptId)}`,
    paymentDetails: (feePaymentId) => `/api/v1/fees/payments/${encodeURIComponent(feePaymentId)}`,
    deletePayment: (id) => `/api/fees/payment/${id}`,
    concessions: "/api/v1/fees/concessions",
