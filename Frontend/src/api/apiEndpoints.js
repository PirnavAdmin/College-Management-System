export const apiEndpoints = {
  ...
  departments: {
    ...
    exportTemplate: "/api/v1/departments/export-template",
    template: "/api/v1/departments/export-template",
  },
  designations: {
    ...
    summary: "/api/v1/designations/summary",
    validateName: "/api/v1/designations/validate-name",
    importExcel: "/api/v1/designations/import-excel",
    exportExcel: "/api/v1/designations/export-excel",
    exportTemplate: "/api/v1/designations/export-template",
    template: "/api/v1/designations/export-template",
  },
  sections: {
  ...
  certificates: {
    ...
    templateByCode: (templateCode) => `/api/v1/certificates/template-by-code/${encodeURIComponent(templateCode)}`,
    renderTemplate: "/api/v1/certificates/render-template",
    previewTemplate: "/api/v1/certificates/preview-template",
    workflowStats: "/api/v1/certificates/workflow-stats",
    studentsDropdown: "/api/v1/certificates/students-dropdown",
    getById: (id) => `/api/v1/certificates/${encodeURIComponent(id)}`,
    delete: (id) => `/api/v1/certificates/${encodeURIComponent(id)}`,
    generate: "/api/v1/certificates/generate",
    review: (id) => `/api/v1/certificates/${encodeURIComponent(id)}/review`,
    approve: (id) => `/api/v1/certificates/${encodeURIComponent(id)}/approve`,
    issue: (id, issuedBy) => {
      const base = `/api/v1/certificates/${encodeURIComponent(id)}/issue`;
      return issuedBy ? `${base}?issuedBy=${encodeURIComponent(issuedBy)}` : base;
    },
    bulkReview: "/api/v1/certificates/bulk-review",
    bulkApprove: "/api/v1/certificates/bulk-approve",
    bulkIssue: (issuedBy) => {
      const base = "/api/v1/certificates/bulk-issue";
      return issuedBy ? `${base}?issuedBy=${encodeURIComponent(issuedBy)}` : base;
    },
    bulkGenerate: "/api/v1/certificates/bulk-generate",
    bulkEligibleStudents: "/api/v1/certificates/bulk-eligible-students",
    cancel: (id) => `/api/v1/certificates/${encodeURIComponent(id)}/cancel`,
    reissue: "/api/v1/certificates/reissue",
    verify: (certificateNo) => `/api/v1/certificates/verify/${encodeURIComponent(certificateNo)}`,
    download: (id) => `/api/v1/certificates/download/${encodeURIComponent(id)}`,
    exportExcel: "/api/v1/certificates/export/excel",
    exportPdf: "/api/v1/certificates/export/pdf",
  },
  examinations: {
