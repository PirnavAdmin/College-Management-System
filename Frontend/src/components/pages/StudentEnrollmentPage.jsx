...
export default function StudentEnrollmentPage({ id }) {
  ...
  if (loading) return <DashboardLayout title="Edit Profile" breadcrumb={["People", "Students"]}><div className="cms-card"><div className="cms-empty">Loading student record...</div></div></DashboardLayout>;
  if (!student) return <DashboardLayout title="Edit Profile" breadcrumb={["People", "Students"]}><div className="cms-card"><div className="cms-empty">{loadError || "Student record was not found."}</div></div></DashboardLayout>;
